...
|                         | Ratio of Train/Valid                        | :heavy_check_mark:(specify the validation lines)             | :heavy_check_mark:(ratio or specify validation lines) | ❌                                                            | :heavy_check_mark:(specify the validation lines)             |
